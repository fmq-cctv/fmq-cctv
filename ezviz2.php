...
if (isset($_POST['order'])){
    ...
    if ($db->query($sql)) {
        try {
            ...
            $mail->Body    = "
            Hai, $username! <br><br>
            Terima kasih telah melakukan pemesanan paket CCTV Ezviz.<br>
...
<div class="container psn-ezviz1">
    <div class="psn justify-content-center">
        <h1>Pesan Paket CCTV 4 Channel Ezviz</h1>
        <div class="row justify-content-center">
            <div class="col-lg-3 psnn">
              <img src="img/ezviz2.png" alt="Ezviz CCTV">
              <h3 id="price">Rp3.550.000,00</h3>
            </div>
            <div class="col-lg-3 data">
                <form action="ezviz2.php" onsubmit="order();return false;" method="POST">
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="paket" name="paket" value="Paket 4 CCTV Ezviz" required>
                                <span class="span">Paket 4 CCTV Ezviz</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="price" name="price" value="Rp3.550.000,00" required>
                                <span class="span">Rp3.550.000,00</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <a class="btn3" href="paket.php#ezviz" role="button">Batalkan Pesanan</a>
                            </td>
                        </tr>
                    </table>
                </form>
