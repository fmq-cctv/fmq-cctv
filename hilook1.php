...
<div class="container psn-ezviz1">
    <div class="psn justify-content-center">
        <h1>Pesan Paket CCTV 2 Channel Hilook</h1>
        <div class="row justify-content-center">
            <div class="col-lg-3 psnn">
              <img src="img/hilook1.png" alt="Hilook CCTV">
              <h3 id="price">Rp2.699.000,00</h3>
            </div>
                ...
                <form action="ezviz1.php" onsubmit="order();return false;" method="POST">
                    <table>
                        ...
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="paket" name="paket" value="Paket 2 CCTV Hilook" required>
                                <span class="span">Paket 2 CCTV Hilook</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="price" name="price" value="Rp2.699.000,00" required>
                                <span class="span">Rp2.699.000,00</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
