...
<div class="container psn-ezviz1">
    <div class="psn justify-content-center">
        <h1>Pesan Paket CCTV 2 Channel Ezviz</h1>
        <div class="row justify-content-center">
            <div class="col-lg-3 psnn">
              <img src="img/ezviz1.png" alt="Ezviz CCTV">
              <h3 id="price">Rp1.950.000,00</h3>
            </div>
            <div class="col-lg-3 data">
                <form action="ezviz1.php" onsubmit="order();return false;" method="POST">
                    <table>
                        <tr>
                            <td>
                        ...
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="paket" name="paket" value="Paket 2 CCTV Ezviz" required>
                                <span class="span">Paket 2 CCTV Ezviz</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="price" name="price" value="Rp1.950.000,00" required>
                                <span class="span">Rp1.950.000,00</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
