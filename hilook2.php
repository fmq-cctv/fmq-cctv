    ...
    <div class="psn justify-content-center">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 psnn">
              <img src="img/hilook2.png" alt="Ezviz CCTV">
              <h3 id="price">Rp3.799.000,00</h3>
            </div>
                ...
                <form action="hilook2.php" onsubmit="order();return false;" method="POST">
                    <table>
                        ...
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="paket" name="paket" value="Paket 4 CCTV Hilook" required>
                                <span class="span">Paket 4 CCTV Hilook</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <label>
                                <input class="checkbox" type="checkbox" id="price" name="price" value="Rp3.799.000,00" required>
                                <span class="span">Rp3.799.000,00</span>
                            </label>
                          </td>
                        </tr>
                        <tr>
